...
class Guess
{
    ...
    /**
     * Make a guess_orig, decrease remaining guesses and return a string stating
     * if the guess_orig was correct, too low or to high or if no guesses remains.
     *
    ...
    public function makeGuess(int $number)
    {
        ...
        if ($this->getTries() >= 6) {
            $this->lastResult = "your last guess_orig!";
        } else {
