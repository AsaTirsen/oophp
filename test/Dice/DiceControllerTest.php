...
class DiceControllerTest extends TestCase
{
    ...
    public function testIndexAction()
    {
        ...
        $this->assertStringContainsString("Start Dice", $res);
    }
    ...
    /**
     * Call the controller playActionPost method.
     */
    ...
    /**
     * Call the controller playActionGet method.
     */
